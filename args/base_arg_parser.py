...
class BaseArgParser(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--model', type=str, choices=('PENet', 'PENetClassifier','Fusion'), default='PENet',
        ...
        self.parser.add_argument('--save_dir', type=str, default='./data/ckpt/',
    ...
    def parse_args(self):
        ...
        if self.is_training and args.use_pretrained:
            if args.model != 'PENet' and args.model != 'PENetClassifier' and args.model != 'Fusion':
